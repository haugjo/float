...
class TestFIRES(unittest.TestCase):
    ...
    def test_init(self):
        self.assertEqual(self.fires.reset_after_drift, False,
                         msg='attribute reset_after_drift is initialized correctly')
        self.assertIsInstance(self.fires.n_total_features, int,
                              msg='attribute n_total_features is initialized correctly')
        self.assertIsInstance(self.fires.n_selected_features, int,
        ...
        self.assertTrue(type(self.fires.ref_sample) in [float, np.ndarray],
                        msg='attribute ref_sample is initialized correctly')
        self.assertEqual(self.fires.supports_multi_class, False,
                         msg='attribute supports_multi_class is initialized correctly')
        self.assertEqual(self.fires.weights.shape, (self.fires.n_total_features,),
        ...
        self.assertIsInstance(self.fires.selected_features_history, list,
        ...
        self.assertEqual(self.fires._scale_warning_issued, False,
    ...
    def test_weight_features(self):
        ...
        self.assertEqual(weights.shape, self.fires.weights.shape,
    ...
    def test_select_features(self):
        ...
        self.assertEqual(len(self.fires.selected_features), self.fires.n_selected_features,
                         msg='select_features() sets the attribute selected_features correctly')
        self.assertEqual(len(self.fires.weights_history), 1,
                         msg='select_features() sets the attribute weights_history correctly')
        self.assertEqual(len(self.fires.weights_history[0]), self.fires.n_total_features,
                         msg='select_features() sets the attribute weights_history correctly')
        self.assertEqual(len(self.fires.selected_features_history), 1,
                         msg='select_features() sets the attribute selected_features_history correctly')
        self.assertEqual(len(self.fires.selected_features_history[0]), self.fires.n_selected_features,
                         msg='select_features() sets the attribute selected_features_history correctly')
        self.assertTrue((X_new[:, ~self.fires.selected_features] == 0).all(),
    ...
    def test_reset(self):
        ...
        self.assertTrue((self.fires._sigma == (1 * self.fires._sigma_init)).all(),
                        msg='reset() resets attribute sigma correctly')
