...
class TestOFS(unittest.TestCase):
    ...
    def test_init(self):
        self.assertEqual(self.ofs.reset_after_drift, False,
        ...
        self.assertIsInstance(self.ofs.n_selected_features, int,
        ...
        self.assertTrue(type(self.ofs.ref_sample) in [float, np.ndarray],
                        msg='attribute ref_sample is initialized correctly')
        self.assertEqual(self.ofs.supports_multi_class, False,
                         msg='attribute supports_multi_class is initialized correctly')
        self.assertEqual(self.ofs.weights.shape, (self.ofs.n_total_features,),
        ...
        self.assertIsInstance(self.ofs.selected_features_history, list,
        ...
        self.assertEqual(self.ofs._scale_warning_issued, False,
    ...
    def test_weight_features(self):
        ...
        self.assertEqual(weights.shape, self.ofs.weights.shape,
    ...
    def test_select_features(self):
        ...
        self.assertEqual(len(self.ofs.selected_features), self.ofs.n_selected_features,
                         msg='select_features() sets the attribute selected_features correctly')
        self.assertEqual(len(self.ofs.weights_history), 1,
                         msg='select_features() sets the attribute weights_history correctly')
        self.assertEqual(len(self.ofs.weights_history[0]), self.ofs.n_total_features,
                         msg='select_features() sets the attribute weights_history correctly')
        self.assertEqual(len(self.ofs.selected_features_history), 1,
                         msg='select_features() sets the attribute selected_features_history correctly')
        self.assertEqual(len(self.ofs.selected_features_history[0]), self.ofs.n_selected_features,
                         msg='select_features() sets the attribute selected_features_history correctly')
        self.assertTrue((X_new[:, ~self.ofs.selected_features] == 0).all(),
